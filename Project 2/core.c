...
static void __sched notrace __schedule(unsigned int sched_mode)
{
	...
	/*
	 * If the static priority of the previous task is not 0, and the fixed priority
	 * of the previous task is within the valid range of 101 to 139 (inclusive),
	 * update the static priority of the previous task to match the fixed priority.
	 */
